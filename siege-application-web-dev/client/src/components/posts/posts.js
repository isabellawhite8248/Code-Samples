...
// still working on making the scrollbar look like the one in the picture, 
//any other feedback on what to fix would be appreciated
                  ...
                  <CustomScrollbars style={{width: '100%', height: 680}}>
                    ...
                    <Flex sx={postFlexStyle} >
                            ...
                            <Flex sx={postFlexStyle2}>
                                ...
                                {/* left portion of the flex box which holds content for each post */}
                                  <SimpleGrid sx={gridStyles}>
                                    ...
                                    <Box sx={leftPostBoxStyles} height='0.5em'> <Text class='bodytext'>1298</Text> </Box>
                                    ...
                                    <Box sx={leftPostBoxStyles} height='2em'></Box>
                                    <Box sx={leftPostBoxStyles} height='2em'> </Box>
                                  </SimpleGrid>
                                </Center>
                              ...
                              <Box sx={rightPostBoxStyles}>
                                ...
                                <Text class='postbody'> industryy. Lorem Ipsum has been leap into electronic typesetting, rem has been leap into electronic typesetting, rem Lorem Ipsum has been leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing</Text>
                                </Box>
